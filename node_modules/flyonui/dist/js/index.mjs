 ...
 * Copyright 2024 Preline Labs Ltd.
 */
const T={getClassProperty:k.gj,afterTransition:k.yd,autoInit(e="all"){"all"===e?E.forEach((({fn:e})=>{null==e||e.autoInit()})):E.forEach((({key:t,fn:i})=>{e.includes(t)&&(null==i||i.autoInit())}))},cleanCollection(e="all"){"all"===e?E.forEach((({collection:e})=>{window[e]instanceof Array&&(window[e]=[])})):E.forEach((({key:t,collection:i})=>{e.includes(t)&&window[i]instanceof Array&&(window[i]=[])}))}};"undefined"!=typeof window&&(window.HSStaticMethods=T);const A=T;
/*
 * @version: 2.7.0
 * @author: Preline Labs Ltd.
 * @license: Licensed under MIT and Preline UI Fair Use License (https://preline.co/docs/license.html)
